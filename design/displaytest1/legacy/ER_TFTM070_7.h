#ifndef ER_TFTM070_7_h
#define ER_TFTM070_7_h
#include "Arduino.h"
...
//https://rgbcolorpicker.com/565 use for conversion
#define Black   0x0000
#define mainGrey  0x8410// Proper medium grey
#define darkerGrey  0x2104
#define White   0xffff
// #define mainGrey  0x8410 // Proper medium grey
// #define darkerGrey  0x2104
...
// Color palette from swatch - Top 5 colors
// RGB565 format: RRRRR GGGGGG BBBBB (5 bits red, 6 bits green, 5 bits blue)
#define light_Orange_Coral    0xfcca  
#define light_Pink_Pastel     0xfc5b 
#define light_Pink_Magenta    0xfad6  
#define light_Green_Lime      0xc714  
#define light_Green_Forest    0x2A66  

#define Orange_Coral    0xf260  
#define Pink_Pastel     0xe855 
#define Pink_Magenta    0x6807  
#define Green_Lime      0x756a  
#define Green_Forest    0x2A66  

// Color palette from swatch - Darkest versions from bottom
#define Orange_dark      0x9980  // #471500 - R=71(8), G=21(5), B=0(0)
#define Purple_Dark     0x6829  // #450231 - R=69(8), G=2(0), B=49(6)
#define Magenta_Dark    0x714a  // #460026 - R=70(8), G=0(0), B=38(4)

#define Green_Lime_dark 0x3287

#define Green_Olive_Dark 0x3285 // #233610 - R=35(4), G=54(13), B=16(2) - CORRECT
#define Green_Teal_Dark 0x1963  // #192d1f - R=25(3), G=45(11), B=31(3) - CORRECT
