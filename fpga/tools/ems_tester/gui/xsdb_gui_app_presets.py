...
class RegisterControlWidget(QWidget):
    ...
    def init_ui(self):
        ...
        other_defs = [
            ...
            ("0x7C", "classic_dac", "Classic Mode DAC (1=EMS table, 0=linear)", 1, 0, 1, 0),
            ("0x7C", "classic_x_delay", "Classic Mode X Delay (1=cnt 1/3/4 +1/2/3 clk)", 1, 0, 1, 1),
            ("0x7C", "classic_43_mask", "Classic Mode 4:3 Mask (720p pillarbox, off at start)", 1, 0, 1, 2),
            ("0x7C", "classic_luma_lift", "Classic Mode Luma +25 (sat, no overflow)", 1, 0, 1, 3),
