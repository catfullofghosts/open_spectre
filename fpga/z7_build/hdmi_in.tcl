...
\
  ...
  # Create instance: spector_wrapper_zynq_0, and set properties
  set block_name spector_wrapper_zynq
  set block_cell_name spector_wrapper_zynq_0
  if { [catch {set spector_wrapper_zynq_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spector_wrapper_zynq_0 eq "" } {
  ...
  # Create instance: axi_mem_intercon5, and set properties
  set axi_mem_intercon5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon5 ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon5_M00_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP0] [get_bd_intf_pins axi_mem_intercon5/M00_AXI]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_MM2S [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon5/S00_AXI]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_S2MM [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon5/S01_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph2/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph2_M00_AXI [get_bd_intf_pins ps7_0_axi_periph2/M00_AXI] [get_bd_intf_pins axi_dynclk_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph2_M01_AXI [get_bd_intf_pins ps7_0_axi_periph2/M01_AXI] [get_bd_intf_pins axi_gpio_video/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph2_M02_AXI [get_bd_intf_pins ps7_0_axi_periph2/M02_AXI] [get_bd_intf_pins axi_vdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph2_M03_AXI [get_bd_intf_pins ps7_0_axi_periph2/M03_AXI] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net ps7_0_axi_periph2_M04_AXI [get_bd_intf_pins ps7_0_axi_periph2/M04_AXI] [get_bd_intf_pins v_tc_1/ctrl]
  connect_bd_intf_net -intf_net ps7_0_axi_periph2_M05_AXI [get_bd_intf_pins ps7_0_axi_periph2/M05_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  ...
  [get_bd_pins spector_wrapper_zynq_0/pix_clk]
  ...
  [get_bd_pins ps7_0_axi_periph2/ACLK] \
  [get_bd_pins ps7_0_axi_periph2/S00_ACLK] \
  [get_bd_pins ps7_0_axi_periph2/M02_ACLK] \
  [get_bd_pins ps7_0_axi_periph2/M01_ACLK] \
  [get_bd_pins ps7_0_axi_periph2/M03_ACLK] \
  [get_bd_pins ps7_0_axi_periph2/M04_ACLK] \
  [get_bd_pins ps7_0_axi_periph2/M05_ACLK] \
  [get_bd_pins ps7_0_axi_periph2/M00_ACLK]
  ...
  [get_bd_pins axi_mem_intercon5/S01_ACLK] \
  [get_bd_pins axi_mem_intercon5/M00_ACLK] \
  [get_bd_pins axi_mem_intercon5/S00_ACLK] \
  [get_bd_pins axi_mem_intercon5/ACLK] \
  ...
  [get_bd_pins ps7_0_axi_periph2/M00_ARESETN] \
  [get_bd_pins ps7_0_axi_periph2/S00_ARESETN] \
  [get_bd_pins ps7_0_axi_periph2/M01_ARESETN] \
  [get_bd_pins ps7_0_axi_periph2/M02_ARESETN] \
  [get_bd_pins ps7_0_axi_periph2/M03_ARESETN] \
  [get_bd_pins ps7_0_axi_periph2/M04_ARESETN] \
  [get_bd_pins ps7_0_axi_periph2/M05_ARESETN]
  ...
  [get_bd_pins axi_mem_intercon5/S01_ARESETN] \
  [get_bd_pins axi_mem_intercon5/M00_ARESETN] \
  [get_bd_pins axi_mem_intercon5/S00_ARESETN] \
  ...
  connect_bd_net -net spector_wrapper_zynq_0_v_sync_o  [get_bd_pins spector_wrapper_zynq_0/v_sync_o] \
  [get_bd_pins rgb2dvi_0/vid_pVSync]
  connect_bd_net -net spector_wrapper_zynq_0_video_out  [get_bd_pins spector_wrapper_zynq_0/video_out] \
  ...
  connect_bd_net -net vid_in_mux_0_1  [get_bd_ports sw0] \
  [get_bd_pins spector_wrapper_zynq_0/vid_in_mux]
