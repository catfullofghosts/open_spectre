...
proc create_root_design { parentCell } {
  ...
  set regs_bram_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 regs_bram_0 ]
  set_property -dict [ list \
  ...
  set clk_74_25 [ create_bd_port -dir O -type clk clk_74_25 ]
  set clk_TMDS [ create_bd_port -dir O -type clk clk_TMDS ]
  set_property -dict [ list \
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT3_JITTER {340.171} \
    CONFIG.CLKOUT3_PHASE_ERROR {610.813} \
    CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {74.25595} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_ports regs_bram_0] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
